	...
	<style type="text/css">
		...
		<div class="calendar-wrap noto">
			<div data-aos="fade-up" data-delay="2000" data-aos-duration="1500">
				<form action="" name="listFrm" id="listFrm" method="post">
					<fieldset>
				...
				<div class="section-inner">
					...
					<div class="box-list-wrap">
						...
						<c:if test="${totalCnt > 0 }">
							<c:forEach var="gallery_list" items="${gallery_list}" varStatus="status">
								<div class="box">
									<a href="/bbs/gallery_view.do?nttId=${gallery_list.nttId}">
										<div class="img-area">
											<!-- <img src="/_cmm/fms/getImage.do?atchFileId=ATCHFILEID&imgFlag=thumbnail&thumbnail=true" alt="이미지영역"> -->
											<img src="/_admin/img/no_img.jpg" alt="이미지가 없습니다.">
										</div>
										<div class="box-con">
											<p class="box-tit dotdot">${gallery_list.nttSj}</p>
											<p class="date">${fn:substring(gallery_list.frstRegistPnttm,0,11)}</p>
										</div>
									</a>
								</div>
							</c:forEach>
